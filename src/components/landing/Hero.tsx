...
export function Hero() {
  ...
  return (
    <section className="relative z-10 mx-auto max-w-6xl px-6 pb-16 pt-20 md:pt-28">
      ...
      <h1 className="mt-5 min-h-[2.4em] max-w-3xl text-4xl font-semibold leading-[1.1] text-text-primary md:min-h-[2.2em] md:text-6xl">
        {line0}
        <br />
        {line1}
        {typing && <span className="blink-cursor ml-1 inline-block h-[0.9em] w-[3px] bg-signal align-middle" />}
      </h1>
