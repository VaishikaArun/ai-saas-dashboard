...
export function Footer() {
  return (
    <footer className="relative z-10 border-t border-line">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-8 font-mono text-xs uppercase tracking-widest text-text-muted sm:flex-row sm:items-center sm:justify-between">
